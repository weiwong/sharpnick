...
{
	/// <summary>
	/// Moves Javascripts to the bottom of output HTML pages.
	/// </summary>
	/// <remarks>Source unknown. Might be on CodeProject, but has since propagated to other projects as well.
	/// e.g. http://code.google.com/p/dropthings/source/browse/trunk/src/Dropthings.Web.Util/ScriptDeferFilter.cs </remarks>
	public class ScriptDeferFilter : Stream
	{
		...
		{
			string output = scriptBlocks.ToString();
		...
		private static bool IsPinned(char[] content, int pos)
		{
